  ...
  return (
    <div className="min-h-screen flex items-center justify-start bg-stone-100 px-6 lg:px-20">
      <div className="w-full max-w-sm">
        <h1 className="text-3xl font-bold text-stone-900 mb-1">Knowledge Assistant</h1>
        <p className="text-stone-500 mb-8 text-sm">Sign in to access your documents and conversations.</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label htmlFor="login-password" className="block text-sm font-medium text-stone-700 mb-1">Password</label>
            <input
              id="login-password"
              type="password"
              required
        ...
        <p className="mt-6 text-sm text-stone-500">
          No account?{' '}
          <Link to="/register" className="text-teal-700 hover:text-teal-800 font-medium">Create one</Link>
        </p>
      </div>
    </div>
  )
