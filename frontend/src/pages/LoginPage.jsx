      ...
      <div className="w-full lg:w-[480px] shrink-0 bg-white flex flex-col justify-center px-10 sm:px-14 py-14 border-r border-[#ebebeb]">
        <div className="w-full max-w-[340px] mx-auto">
          ...
          <p className="text-[14px] text-[#737373] leading-relaxed mb-8">
            Access your documents and start asking questions.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label htmlFor="login-email" className="block text-[13px] font-medium text-[#525252] mb-2">
                Email
              </label>
              <input
                id="login-email"
            ...
            <div>
              <label htmlFor="login-password" className="block text-[13px] font-medium text-[#525252] mb-2">
                Password
              </label>
              <input
                id="login-password"
